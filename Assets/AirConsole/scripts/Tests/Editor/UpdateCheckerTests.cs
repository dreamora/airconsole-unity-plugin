...
namespace NDream.AirConsole.Editor.Tests {
    ...
    public class UpdateCheckerTests {
        ...
        public void IsUpdateAvailable_PropertyAccessible() {
            ...
            Assert.DoesNotThrow(() => {
                bool result = UpdateChecker.IsUpdateAvailable;
            });
        }
        ...
        public void LatestVersion_ReturnsGithubUpdateLatestVersion() {
            ...
            Version githubLatestVersion = GithubUpdate.LatestVersion;
        ...
        public void IsCheckInProgress_ReturnsGithubUpdateIsCheckInProgress() {
            // Act
            bool isInProgress = UpdateChecker.IsCheckInProgress;
            bool githubIsInProgress = GithubUpdate.IsCheckInProgress;
        ...
        public void LastCheckTime_ReturnsGithubUpdateLastCheckTime() {
            ...
            DateTime githubLastCheckTime = GithubUpdate.LastCheckTime;
        ...
        public void IsCurrentUpdateDismissed_PropertyAccessible() {
            ...
            bool result = UpdateChecker.IsCurrentUpdateDismissed;
        ...
        public void StartAutomaticChecking_WithValidSettings_InitializesSuccessfully() {
            ...
            UpdateSettings settings = UpdateSettings.Instance;
            bool originalEnabled = settings.AutomaticCheckEnabled;
            bool originalCheckOnStartup = settings.CheckOnStartup;
        ...
        public void CanCheckNow_ReturnsGithubUpdateCanCheckNow() {
            // Act
            bool canCheck = UpdateChecker.CanCheckNow();
            bool githubCanCheck = GithubUpdate.CanCheckNow();
        ...
        public void TimeUntilNextCheck_ReturnsGithubUpdateTimeUntilNextCheck() {
            ...
            TimeSpan githubTimeUntilNext = GithubUpdate.TimeUntilNextCheck();

            // Assert - Should return values within a small tolerance (due to timing differences)
            double difference = Math.Abs((timeUntilNext - githubTimeUntilNext).TotalMilliseconds);
        ...
        public void DismissVersion_WithValidVersion_CallsGithubUpdateDismissVersion() {
            ...
            UpdateSettings settings = UpdateSettings.Instance;
            string originalDismissed = settings.DismissedVersion;
        ...
        public void IsVersionDismissed_WithValidVersion_ReturnsGithubUpdateResult() {
            ...
            try {
                ...
                // Act
                bool isDismissed = UpdateChecker.IsVersionDismissed(version);
                bool githubIsDismissed = GithubUpdate.IsVersionDismissed(version);
                ...
                bool isNotDismissed = UpdateChecker.IsVersionDismissed(version);
                bool githubIsNotDismissed = GithubUpdate.IsVersionDismissed(version);
        ...
        public void IsVersionDismissed_WithNullVersion_ReturnsFalse() {
            // Act
            bool result = UpdateChecker.IsVersionDismissed(null);
        ...
        public void DownloadAndInstallUpdate_MethodExists() {
            ...
            MethodInfo method = typeof(UpdateChecker).GetMethod("DownloadAndInstallUpdate",
        ...
        public void DownloadAndInstallUpdateWithoutConfirmation_MethodExists() {
            ...
            // This avoids UI dialogs during unit tests
            MethodInfo method = typeof(UpdateChecker).GetMethod("DownloadAndInstallUpdateWithoutConfirmation",
                BindingFlags.Public | BindingFlags.Static);
        ...
        public void UpdateChecker_IntegrationWithGithubUpdate_WorksCorrectly() {
            ...
            TimeSpan updateCheckerTime = UpdateChecker.TimeUntilNextCheck();
            TimeSpan githubUpdateTime = GithubUpdate.TimeUntilNextCheck();
            double timeDifference = Math.Abs((updateCheckerTime - githubUpdateTime).TotalMilliseconds);
        ...
        public void StartupInitialization_FirstTimeSetup_CreatesSettingsAsset() {
            ...
            try {
                ...
                Assert.AreEqual(12, settings.CheckIntervalHours, "Default interval should be 12 hours");
        ...
        public void UpdateChecker_HandlesNullLatestVersionGracefully() {
            ...
            Assert.DoesNotThrow(() => {
                ...
                bool isCurrentDismissed = UpdateChecker.IsCurrentUpdateDismissed;
